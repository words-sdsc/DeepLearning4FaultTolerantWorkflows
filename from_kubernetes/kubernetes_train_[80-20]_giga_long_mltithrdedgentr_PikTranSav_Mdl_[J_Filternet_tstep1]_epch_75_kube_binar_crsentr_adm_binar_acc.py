...
def getj():
    ...
    try:
        ...
        newthreadcounter = (1+retval)%totalnofiles
...
model.load_weights('kubernetes_train_[80-20]_giga_long_mltithrdedgentr_PikTranSav_Mdl_[J_Filternet_tstep1]_epch_25_kube_binar_crsentr_adm_binar_acc.h5')
########################################################
...
model.save_weights(path + 'kubernetes_train_[80-20]_giga_long_mltithrdedgentr_PikTranSav_Mdl_[J_Filternet_tstep1]_epch_75_kube_binar_crsentr_adm_binar_acc.h5')
print('Weights Saved')
########################################################
