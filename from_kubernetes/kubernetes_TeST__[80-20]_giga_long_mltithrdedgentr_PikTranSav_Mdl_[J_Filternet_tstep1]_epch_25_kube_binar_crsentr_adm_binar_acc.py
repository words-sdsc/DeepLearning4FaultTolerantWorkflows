...
modelfingerprint     = "comet_train_[80-20]_giga_long_mltithrdedgentr_PikTranSav_Mdl_[J_Filternet_tstep1]_epch_25_kube_binar_crsentr_adm_binar_acc_tsteps1.py" # name of py file
modelweightsfilename = "comet_train_[80-20]_giga_long_mltithrdedgentr_PikTranSav_Mdl_[J_Filternet_tstep1]_epch_25_kube_binar_crsentr_adm_binar_acc_tsteps1.h5" # name of h5 file
