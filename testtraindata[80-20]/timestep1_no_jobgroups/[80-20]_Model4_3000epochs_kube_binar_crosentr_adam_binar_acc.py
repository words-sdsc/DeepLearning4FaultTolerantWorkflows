...
def create_model4(input_dim = input_dim, input_length = input_length, output_dim=output_dim):
...
model       = create_model4()
history     = model.fit(X_final,Y_final,batch_size=500000, epochs=3000, validation_split = 0.10, 
...
#Save
mode.save_weights('[80-20]_Model4_weights_3000epochs_kube_binar_crosentr_adam_binar_acc.h5')
