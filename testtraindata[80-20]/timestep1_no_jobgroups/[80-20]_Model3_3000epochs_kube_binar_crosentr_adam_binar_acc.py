...
loss, accuracy = model.evaluate(X_test, Y_test, batch_size=500000)
print('Loss and Accuracy: ', loss, accuracy)

#Save
model.save_weights('weights_model3_8020split_3000epochs_kubernetes.h5')

print('Model weights have been saved successfully')

y_pred      = model.predict(X_test, batch_size = 500000)
