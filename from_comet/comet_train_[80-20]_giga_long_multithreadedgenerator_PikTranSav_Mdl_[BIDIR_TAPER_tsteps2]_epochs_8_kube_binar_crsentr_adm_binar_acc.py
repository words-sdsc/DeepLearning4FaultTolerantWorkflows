...
model.save_weights(path + '/comet_train_[80-20]_giga_long_multithreadedgenerator_PikTranSav_Mdl_BIDIR_TAPERby5_epochs_50_kube_binar_crsentr_adm_binar_acc_tsteps2.h5')
print('Weights Saved')
########################################################
