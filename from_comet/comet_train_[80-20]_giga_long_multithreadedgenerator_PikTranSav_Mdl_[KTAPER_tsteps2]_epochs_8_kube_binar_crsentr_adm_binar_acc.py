...
path = "/oasis/scratch/comet/a1singh/temp_project/tsteps2"
...
def create_modelJtaper(input_dim, input_length, output_dim):
    print ('Creating model Jtaper (Pick Train Save)...')
...
model   = create_modelJtaper(input_dim, input_length, output_dim)
# checkpoint
filepath        = path + "/comet_train_[80-20]_giga_long_multithreadedgenerator_PikTranSav_Mdl_Jtaperby5_epochs_50_kube_binar_crsentr_adm_binar_acc_tsteps2_weights_BEST.hdf5"
...
#history=model.fit_generator(train_generator(), steps_per_epoch=totalbatches,epochs=noofiterations,callbacks=callbacks_list, verbose=1,use_multiprocessing=True, workers=1, max_queue_size=2)
########################################################
print("Saving Model weights...")
model.save_weights(path + '/comet_train_[80-20]_giga_long_multithreadedgenerator_PikTranSav_Mdl_Jtaperby5_epochs_50_kube_binar_crsentr_adm_binar_acc_tsteps2.h5')
print('Weights Saved')
########################################################
