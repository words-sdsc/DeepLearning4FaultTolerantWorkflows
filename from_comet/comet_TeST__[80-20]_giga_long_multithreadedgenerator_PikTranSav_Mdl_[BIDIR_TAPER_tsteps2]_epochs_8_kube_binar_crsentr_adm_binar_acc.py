...
modelfingerprint     = "comet_train_[80-20]_giga_long_multithreadedgenerator_PikTranSav_Mdl_[BIDIR_TAPER_tsteps2]_epochs_8_kube_binar_crsentr_adm_binar_acc.py" # name of py file
modelweightsfilename = "comet_train_[80-20]_giga_long_multithreadedgenerator_PikTranSav_Mdl_[BIDIR_TAPER_tsteps2]_epochs_8_kube_binar_crsentr_adm_binar_acc.h5" # name of h5 file
