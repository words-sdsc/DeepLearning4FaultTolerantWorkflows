...
def getj():
    ...
    try:
        ...
        newthreadcounter = (1+retval)%totalnofiles  #there are 48 training files
...
weightsfile = join(path,"comet_train_[80-20]_giga_long_multithreadedgenerator_PikTranSav_Mdl_[BIDIR_TAPER_tsteps2]_epochs_28_kube_binar_crsentr_adm_binar_acc.h5")
...
model.save_weights(path + '/comet_train_[80-20]_giga_long_multithreadedgenerator_PikTranSav_Mdl_[BIDIR_TAPER_tsteps2]_epochs_48_kube_binar_crsentr_adm_binar_acc.h5')
print('Weights Saved')
########################################################
