...
def printTestResults(model):
    ...
    print('[80-20]_giga_long_generator_PikTranSav_Mdl_J3_totaliterations_20_kube_binar_crsentr_adm_binar_acc.h5')
...
model.save_weights('[80-20]_giga_long_generator_PikTranSav_Mdl_J3_totaliterations_20_kube_binar_crsentr_adm_binar_acc.h5')
print('Weights Saved')
