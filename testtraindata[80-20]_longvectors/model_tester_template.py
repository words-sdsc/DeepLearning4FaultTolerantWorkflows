...
path                 = "/oasis/scratch/comet/a1singh/temp_project/" #path to dir where test pickles reside and h5 file is
modelfingerprint     = "" # name of py file
modelweightsfilename = "" # name of h5 file
