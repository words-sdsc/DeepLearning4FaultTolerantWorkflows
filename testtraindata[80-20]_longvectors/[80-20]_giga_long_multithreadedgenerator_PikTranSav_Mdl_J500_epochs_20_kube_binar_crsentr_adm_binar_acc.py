...
def create_modelJ1000(input_dim, input_length, output_dim):
    print ('Creating model J1000 (Pick Train Save)...')
...
def printTestResults(model):
    ...
    print('[80-20]_giga_long_multithreadedgenerator_PikTranSav_Mdl_J1000_epochs_20_kube_binar_crsentr_adm_binar_acc.h5')
...
model   = create_modelJ1000(input_dim, input_length, output_dim)
...
model.save_weights('[80-20]_giga_long_multithreadedgenerator_PikTranSav_Mdl_J1000_epochs_20_kube_binar_crsentr_adm_binar_acc.h5')
